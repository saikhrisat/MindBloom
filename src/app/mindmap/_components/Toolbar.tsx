...
import { PlusSquare, ZoomIn, ZoomOut, TreeDeciduous, Sun, Moon, Save, Trash2, FolderOpen, Download } from 'lucide-react';
    ...
    <TooltipProvider>
      <div className="p-4 bg-card border-b shadow-sm flex flex-wrap items-center justify-between gap-4 sticky top-0 z-20">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="outline" size="icon" onClick={onExportMarkdown} aria-label="Export as Markdown">
